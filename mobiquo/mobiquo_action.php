...
function action_get_new_topic()
{
    ...
    $request = $smcFunc['db_query']('substring', '
        SELECT
            m.poster_time, SUBSTRING(m.body, 1, 500) AS body, m.smileys_enabled, m.icon, ms.subject, m.id_topic, m.id_member, m.id_msg, b.id_board, b.name AS board_name, t.num_replies, t.num_views,
